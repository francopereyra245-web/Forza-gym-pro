...
return(
<div style={{background:"#0F0F0F",minHeight:"100vh",color:"#fff",fontFamily:"Arial",paddingBottom:80}}>
<div style={{background:"#0A0A0A",padding:12,display:"flex",alignItems:"center",gap:12,borderBottom:"1px solid #222"}}>
<img src="/logo.jpg" style={{width:56,height:56,borderRadius:28,border:"2px solid #FF0000",objectFit:"cover"}} alt="FORZA"/>
...
<div style={{margin:"0 12px",background:"#FF0000",borderRadius:16,padding:16,fontWeight:900}}>🔔 ALARMA HOY TE TOCA - PRINCIPIANTE</div>
<div style={{position:"fixed",bottom:0,left:0,right:0,background:"#0A0A0A",borderTop:"1px solid #222",display:"flex",padding:"8px 0"}}>
{["TIENDA","CATEGORIAS","FAVORITOS","PEDIDOS","MI TIENDA"].map(t=>(
<div key={t} onClick={()=>setTab(t)} style={{flex:1,textAlign:"center",color:tab===t?"#FF0000":"#888"}}>
<div style={{fontSize:20}}>{t==="TIENDA"?"🏠":t==="CATEGORIAS"?"⊞":t==="FAVORITOS"?"★":t==="PEDIDOS"?"📦":"👤"}</div>
<div style={{fontSize:9,fontWeight:tab===t?900:400}}>{t}</div>
</div>
))}
</div>
</div>
