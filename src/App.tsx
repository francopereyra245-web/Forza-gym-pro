      ...
      <div className="min-h-screen bg-black text-white">
        <div className="h-[64vh] relative bg-black rounded-b-[2.5rem] overflow-hidden">
          ...
          <div className={`absolute inset-0 flex items-end justify-center pb-8 transition-all duration-700 ${move?'scale-105 -translate-y-3':'scale-100 translate-y-0'}`}>
            <img src="/forza-bench-rojo.webp" className="h-[90%] w-full object-contain drop-shadow-[0_0_60px_rgba(255,0,0,0.7)]" />
          </div>
        ...
        <div className="p-4">
          <div className="bg-zinc-900 border border-red-900/30 rounded-2xl p-4 flex gap-4">
            ...
            <div><p className="text-[9px] opacity-40 font-bold">MÚSCULO COMPROMETIDO</p><p className="text-red-500 font-black text-sm">Pecho - FAVORABLE</p><p className="text-[11px] opacity-60">Marcado en rojo</p></div>
          </div>
  ...
  return(
    <div className="min-h-screen bg-black text-white pb-24">
      <div className="flex justify-center pt-6">
        <img src="/logo.png" alt="Forza Logo" className="w-20 h-20 object-contain bg-white rounded-2xl p-1" onError={(e:any)=>e.target.style.display='none'} />
      </div>
      <p className="font-black tracking-[0.3em] text-center mt-3 text-sm">FORZA GYM PRO</p>

      <div className="mx-4 mt-5 bg-[#ff4d2e] rounded-2xl p-4 flex gap-3">
        <span>🔔</span>
        <div>
