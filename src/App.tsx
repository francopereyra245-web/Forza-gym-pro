...
export default function App(){
  ...
  <div style={{minHeight:'100vh',background:'#0a0a0a',color:'#fff',fontFamily:'system-ui',paddingBottom:80}}>
    <div style={{padding:14,background:'#000',borderBottom:'1px solid #222',display:'flex',alignItems:'center',gap:10,position:'sticky',top:0}}>
      ...
      <div style={{marginLeft:'auto',fontSize:10,color:'#555'}}>WILDE</div>
    </div>
    <div style={{padding:16}}>
      ...
      {tab==='planes'&&<><h2 style={{fontWeight:900}}>PLANES</h2><div style={{marginTop:12,background:'#dc2626',borderRadius:16,padding:20}}><div style={{fontWeight:900,fontSize:18}}>FORZA PRO</div><div style={{marginTop:6,opacity:0.9}}>$15.000 / mes - Personalizado con Franco</div><a href="https://wa.me/5491150000000" target="_blank" style={{display:'block',textAlign:'center',marginTop:14,background:'#000',color:'#fff',fontWeight:900,padding:14,borderRadius:12,textDecoration:'none'}}>ACTIVAR POR WHATSAPP</a></div></>}
    </div>
