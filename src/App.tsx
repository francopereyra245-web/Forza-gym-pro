  ...
  return(
    <div style={{background:'#0A0A0A',minHeight:'100vh',color:'white',maxWidth:440,margin:'0 auto',paddingBottom:90,fontFamily:'system-ui'}}>
      ...
      <div style={{padding:12}}>
        <div style={{background:ROJO,padding:14,borderRadius:16}}><div style={{fontSize:10}}>HOY TE TOCA</div><div style={{fontWeight:900,fontSize:18}}>{rutinas[0]?.nombre || 'LUNES PECHO'}</div></div>
        <div style={{marginTop:12,background:'#111',padding:12,borderRadius:14,border:'1px solid #222'}}>
          ...
          <div style={{display:'flex',gap:6,marginTop:6}}>
            <input value={nE} onChange={e=>setNE(e.target.value)} placeholder="Press Banca" style={{flex:1,background:'#000',border:'1px solid #333',color:'white',padding:10,borderRadius:10}}/>
